...
class SandboxBrowserTool(SandboxToolsBase):
    ...
    @xml_schema(
        ...
        mappings=[{"param_name": "url", "node_type": "content", "path": "."}],
        example="""
        <function_calls>
    ...
    @xml_schema(
        ...
        mappings=[{"param_name": "seconds", "node_type": "content", "path": "."}],
        example="""
        <function_calls>
    ...
    @xml_schema(
        ...
        mappings=[{"param_name": "index", "node_type": "content", "path": "."}],
        example="""
        <function_calls>
    ...
    @xml_schema(
        ...
        mappings=[{"param_name": "keys", "node_type": "content", "path": "."}],
        example="""
        <function_calls>
    ...
    @xml_schema(
        ...
        mappings=[{"param_name": "page_id", "node_type": "content", "path": "."}],
        example="""
        <function_calls>
    ...
    @xml_schema(
        ...
        mappings=[{"param_name": "amount", "node_type": "content", "path": "."}],
        example="""
        <function_calls>
