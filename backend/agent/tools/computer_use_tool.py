...
from sandbox.tool_base import Sandbox, SandboxToolsBase
...
class ComputerUseTool(SandboxToolsBase):
    ...
    @xml_schema(
        tag_name="scroll",
        mappings=[{"param_name": "amount", "node_type": "attribute", "path": "amount"}],
        example="""
        <function_calls>
        <invoke name="scroll">
    ...
    @xml_schema(
        tag_name="typing",
        mappings=[{"param_name": "text", "node_type": "content", "path": "text"}],
        example="""
        <function_calls>
        <invoke name="typing">
    ...
    @xml_schema(
        tag_name="press",
        mappings=[{"param_name": "key", "node_type": "attribute", "path": "key"}],
        example="""
        <function_calls>
        <invoke name="press">
    ...
    @xml_schema(
        tag_name="mouse-down",
        mappings=[{"param_name": "button", "node_type": "attribute", "path": "button"}],
        example="""
        <function_calls>
    ...
    @xml_schema(
        tag_name="hotkey",
        mappings=[{"param_name": "keys", "node_type": "attribute", "path": "keys"}],
        example="""
        <function_calls>
        <invoke name="hotkey">
